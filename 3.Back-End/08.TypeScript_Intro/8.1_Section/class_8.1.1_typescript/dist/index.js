...
console.log("\nA ÁREA DE UM:");
console.log(`- Losango de diagonais 32cm e 18cm: ${Ex.getRhombusArea(32, 18)}cm²`);
console.log(`- Losango de diagonais 200cm e 50cm: ${Ex.getRhombusArea(200, 50)}cm²`);
console.log(`- Losango de diagonais 75cm e 25cm: ${Ex.getRhombusArea(75, 25)}cm²`);
console.log("\nA ÁREA DE UM:");
console.log(`- Trapézio de bases 100cm e 70cm e altura 50cm: ${Ex.getTrapezoidArea(100, 70, 50)}cm²`);
console.log(`- Trapézio de bases 75cm e 50cm e altura 35cm: ${Ex.getTrapezoidArea(75, 50, 35)}cm²`);
console.log(`- Trapézio de bases 150cm e 120cm e altura 80cm: ${Ex.getTrapezoidArea(150, 120, 80)}cm²`);
console.log("\nA ÁREA DE UM:");
console.log(`- Círculo de raio 25: ${Ex.getCircleArea(25)}cm²`);
console.log(`- Círculo de raio 100: ${Ex.getCircleArea(100)}cm²`);
console.log(`- Círculo de raio 12,5: ${Ex.getCircleArea(12.5)}cm²`);
